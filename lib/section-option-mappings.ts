...
export const SECTION_OPTION_MAPPINGS: SectionOptionMapping[] = [
  ...
  { filePath: "claude", sectionId: "section1", optionId: "option7", configPath: "technologies.postgresql" },
  ...
  { filePath: "claude", sectionId: "section3", optionId: "option2", configPath: "questions.databaseProvider", matchValue: "supabase" },
  ...
  { filePath: "readme", sectionId: "section1", optionId: "option2", configPath: "questions.databaseProvider", matchValue: "supabase" },
  ...
  { filePath: "readme", sectionId: "section2", optionId: "option8", configPath: "technologies.postgresql" },
  ...
  { filePath: "readme", sectionId: "section3", optionId: "option2", configPath: "technologies.supabase" },
  ...
  { filePath: "robots", sectionId: "section1", optionId: "option2", configPath: "questions.databaseProvider", matchValue: "none" },

  { filePath: "robots", sectionId: "section2", optionId: "option1", configPath: "questions.databaseProvider", matchValue: "supabase" },
  { filePath: "robots", sectionId: "section2", optionId: "option2", configPath: "questions.databaseProvider", matchValue: "none" },

  { filePath: "robots", sectionId: "section3", optionId: "option1", configPath: "questions.databaseProvider", matchValue: "supabase" },
  { filePath: "robots", sectionId: "section3", optionId: "option2", configPath: "questions.databaseProvider", matchValue: "none" },
  ...
  { filePath: "docs.deployment-instructions", sectionId: "section2", optionId: "option2", configPath: "technologies.supabase" },
  ...
  { filePath: "docs.util", sectionId: "section2", optionId: "option1", configPath: "questions.databaseProvider", matchValue: "none" },

  { filePath: "docs.util", sectionId: "section3", optionId: "option1", configPath: "questions.databaseProvider", matchValue: "none" },
  { filePath: "docs.util", sectionId: "section3", optionId: "option2", configPath: "questions.databaseProvider", matchValue: "supabase" },

  { filePath: "docs.util", sectionId: "section4", optionId: "option1", configPath: "questions.databaseProvider", matchValue: "none" },
  { filePath: "docs.util", sectionId: "section4", optionId: "option2", configPath: "questions.databaseProvider", matchValue: "supabase" },

  { filePath: "docs.util", sectionId: "section5", optionId: "option1", configPath: "questions.databaseProvider", matchValue: "none" },
  { filePath: "docs.util", sectionId: "section5", optionId: "option2", configPath: "technologies.supabase" },
