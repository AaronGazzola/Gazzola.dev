...
export const reactForgotPasswordEmail = ({
  username,
  resetLink,
        ...
        <Container className="mx-auto py-8 px-4 max-w-md">
          <Section className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <Section className="text-center mb-6">
              <Button
                href={resetLink}
                className="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium text-base hover:bg-blue-700 transition-colors inline-block"
              >
                Reset Password
              </Button>
            </Section>
...
export default reactForgotPasswordEmail;