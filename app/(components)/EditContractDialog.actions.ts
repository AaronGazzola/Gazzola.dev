...
export const addContractAction = withAuthenticatedAction(
  async (
    user,
...
export const updateContractAction = withAuthenticatedAction(
  async (
    user,
        ...
        for (const field of fieldsToCheck) {
          ...
          if (updateValue !== undefined) {
            if (
              ...
              if (
                (existingContract as ExistingContractBase)[field] !==
                updateValue
              ) {
                return true;
              }
...
export const contractPaymentAction = withAuthenticatedAction(
  async (
    user,
    contractId: string,
    userId?: string
