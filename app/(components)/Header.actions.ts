...
import { YouTubeAPIResponse, YouTubeSubscriberData } from "./Header.types";

export async function getYouTubeSubscriberCountAction(): Promise<
  ActionResponse<YouTubeSubscriberData>
> {
  try {
