...
const EditableText = ({
  ...
  if (isEditing) {
    return (
      <Input
        ...
        className={cn(
          "h-5 theme-px-1 theme-py-0 text-sm w-auto inline-block",
          className
        )}
      />
    );
  ...
  return (
    <span
      className={cn(
        "cursor-pointer hover:theme-bg-accent theme-px-1 theme-radius",
        className
      )}
...
const ColumnLine = ({
  ...
  return (
    <div className="group flex items-center hover:theme-bg-accent theme-px-2 theme-py-0.5 theme-radius font-mono text-sm">
      ...
      {column.isDefault ? (
        ...
        >
          <SelectTrigger className="h-5 w-auto theme-px-1 border-none theme-shadow-none theme-bg-transparent theme-text-chart-3 font-mono text-sm">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="sm"
          className="h-5 theme-ml-4 theme-text-muted-foreground hover:theme-text-foreground font-mono text-xs"
        >
          <Plus className="h-3 w-3 theme-mr-1" />
          Add column...
        </Button>
      </PopoverTrigger>
      <PopoverContent className="w-64 theme-p-3" align="start">
...
const ModelBlock = ({
  ...
  return (
    <div className="theme-mb-4">
      <div className="group flex items-center theme-px-2 theme-py-1 hover:theme-bg-accent theme-radius font-mono text-sm">
        <span className="theme-text-keyword theme-font-bold">model</span>
        ...
        <EditableText
          ...
          className="theme-text-foreground theme-font-semibold"
        />
        <span className="theme-mx-2">{" {"}</span>
        {!table.isDefault && (
          <Button
      ...
      {table.uniqueConstraints.length > 0 && (
        <>
          <div className="theme-px-2 theme-py-0.5 font-mono text-sm">
            <span className="theme-text-muted-foreground"> </span>
          </div>
          {table.uniqueConstraints.map((constraint, i) => (
            <div key={i} className="theme-px-2 theme-py-0.5 font-mono text-sm">
              <span className="theme-text-muted-foreground"> </span>
      ...
      <div className="theme-px-2 theme-py-1 font-mono text-sm">
        <span>{"}"}</span>
      </div>
    </div>
  );
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="sm"
          className="h-6 theme-text-muted-foreground hover:theme-text-foreground font-mono text-sm"
        >
          <Plus className="h-3 w-3 theme-mr-1" />
          Add table...
        </Button>
...
const SchemaTab = () => {
  ...
  return (
    <div className="theme-font-mono text-sm theme-bg-muted theme-p-4 theme-radius overflow-auto">
      <div className="theme-mb-4">
        <div className="theme-text-keyword theme-font-bold">datasource</div>
        <div className="theme-pl-2">
      ...
      <div className="theme-mb-6">
        <div className="theme-text-keyword theme-font-bold">generator</div>
        <div className="theme-pl-2">
...
const CodeTab = ({ code, title }: { code: string; title: string }) => {
  ...
  return (
    <div className="relative theme-bg-muted theme-radius overflow-auto">
      <div className="theme-bg-info theme-text-info-foreground theme-px-4 theme-py-2 text-sm theme-font-sans">
      ...
      {copied && (
        <span className="absolute top-2 right-10 text-xs theme-text-success theme-font-sans">
          Copied!
        </span>
      )}
      <pre className="theme-p-4 theme-font-mono text-sm overflow-x-auto">
        <code>{code}</code>
      </pre>
    </div>
  );
...
const RLSTab = () => {
  ...
  return (
    <div className="theme-font-mono text-sm theme-bg-muted theme-p-4 theme-radius overflow-auto">
      <div className="theme-mb-4 theme-font-sans theme-text-muted-foreground text-xs">
...
export const DatabaseConfiguration = () => {
  ...
  return (
    <div className="theme-p-4 theme-radius theme-border-border theme-bg-card theme-text-card-foreground theme-shadow theme-font-sans">
      <Tabs
        value={activeTab}
      ...
      >
        ...
        <TabsContent value="auth">
          <CodeTab code={generateAuthConfig(initialConfiguration)} title="lib/auth.ts" />
        </TabsContent>
