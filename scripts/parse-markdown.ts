...
function main() {
  try {
    ...
    console.log(`✅ Processed markdown data written to ${OUTPUT_FILE}`);
    console.log(`Found ${Object.keys(markdownData.flatIndex).length} nodes`);
    console.log(`Content version: ${markdownData.contentVersion}`);
  } catch (error) {
