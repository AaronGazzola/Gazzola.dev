...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 theme-radius theme-font theme-tracking",
  {
    variants: {
      variant: {
        default:
        ...
        highlight:
          "border-2 shadow-sm text-gray-300 bg-black/60 hover:bg-black/10 font-semibold flex items-center gap-4 px-10 py-8 hover:theme-text-accent-foreground",
        outline:
