...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center theme-radius theme-bg-muted theme-p-1 theme-text-muted-foreground theme-font theme-tracking",
      className
    )}
    {...props}
  />
