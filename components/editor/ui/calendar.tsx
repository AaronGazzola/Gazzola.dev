  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdowns: cn(
          "flex h-[--cell-size] w-full items-center justify-center gap-1.5 text-sm font-medium theme-font theme-tracking",
        ...
        caption_label: cn(
          "select-none font-medium theme-font theme-tracking",
          captionLayout === "label"
            ? "text-sm"
        ...
        weekday: cn(
          "theme-text-muted-foreground flex-1 select-none rounded-md text-[0.8rem] font-normal theme-font theme-tracking",
        ...
        week_number: cn(
          "theme-text-muted-foreground select-none text-[0.8rem] theme-font theme-tracking",
